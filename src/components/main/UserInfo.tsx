...
const UserInfo = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      text: userInfo.twitter_username,
    },
    {
      icon: (
...
const UserInfoBlock = ({ text, icon }: { text: string; icon: React.ReactNode }) => {
  return (
    <div className={`flex items-center gap-3 text-lg ${text ? 'text-white' : 'text-dark-grey'} `}>
      {icon}
